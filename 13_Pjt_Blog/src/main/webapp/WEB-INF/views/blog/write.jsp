...
<script>
	...
	$(function(){
		$('#content').summernote({
			...
			callbacks: {
				// 서머노트의 사용법: 서머노트에서 등록한 이미지는 onImageUpload 이벤트로 넘어가고 function이 동작하는데, 이미지는 files에 저장된다.
				onImageUpload: function(files){            // summernote 편집기에 이미지를 올리면 해당 이미지의 정보는 function의 매개변수 files로 전달된다. (여러개를 저장 => 매개변수 files는 배열의 형식이다)
