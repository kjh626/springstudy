...
<body>
	...
	<h1 id="title"></h1>
	<div>
		<img src="${contextPath}/resources/images/animal5.jpg" width="200px">
	</div>
	<div>
	...
	<div><a href="${contextPath}/detail.do?age=12">상세보기3</a></div>
	<div><a href="${contextPath}/detail.do?name=카카오&age=12">상세보기4</a></div>

	<h1>요청 파라미터-2</h1>
	<div><a href="${contextPath}/detail.me">상세보기1</a></div>
	<div><a href="${contextPath}/detail.me?name=네이버">상세보기2</a></div>
	<div><a href="${contextPath}/detail.me?age=58">상세보기3</a></div>
	<div><a href="${contextPath}/detail.me?name=네이버&age=58">상세보기4</a></div>
